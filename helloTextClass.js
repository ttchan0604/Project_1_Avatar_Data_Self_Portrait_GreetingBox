class helloTextClass{
  ...
  fill('white');
  text('Xin chào', width*.31, height*.3);}}
  pop();
  ...
  stroke(random(myColors));
  noFill();
  rect(width*.113, height*.59, width*.22, height*.17, width*.1, height*.3);
  fill('white');
  ...
  fill('white');
  text('नमस्ते', width*.75, height*.155);}}
  pop();
