...
chainUpDownFromRight[0] = new chainUpDownFromRightClass (width*-.05,height*-.25);
chainUpDownFromRight[1] = new chainUpDownFromRightClass (width*.05,height*-.35);
chainUpDownFromRight[2] = new chainUpDownFromRightClass (width*.15,height*-.45);
chainUpDownFromRight[3] = new chainUpDownFromRightClass (width*.25,height*-.55);
chainUpDownFromRight[4] = new chainUpDownFromRightClass (width*.35,height*-.65);
chainUpDownFromRight[5] = new chainUpDownFromRightClass (width*.45,height*-.75);
chainUpDownFromRight[6] = new chainUpDownFromRightClass (width*.55,height*-.85);
chainUpDownFromRight[7] = new chainUpDownFromRightClass (width*.65,height*-.95);
chainUpDownFromRight[8] = new chainUpDownFromRightClass (width*.75,height*-1);
chainUpDownFromRight[9] = new chainUpDownFromRightClass (width*.85,height*-1.05);
...
chainLeftRightBottom[0] = new  chainLeftRightClass(width*.8,height*0.8);
chainLeftRightBottom[1] = new  chainLeftRightClass(width*.7,height*0.7);
chainLeftRightBottom[2] = new  chainLeftRightClass(width*.6, height*0.6);
chainLeftRightBottom[3] = new  chainLeftRightClass(width*.5, height*0.5);
chainLeftRightBottom[4] = new  chainLeftRightClass(width*.4, height*0.4);
chainLeftRightBottom[5] = new  chainLeftRightClass(width*.3, height*0.3);
chainLeftRightBottom[6] = new  chainLeftRightClass(width*.2, height*0.2);
chainLeftRightBottom[7] = new  chainLeftRightClass(width*.1, height*0.1);
...
if(figureChange == true){
  ...
  springBalance(.46,.61,.1,.05);
  springBalance(.45,.67,.1,.05);
  springBalance(.44,.73,.1,.05);
  springBalance(.45,.79,.1,.05);
  springBalance(.46,.85,.1,.05);
  ...
  // console.log('my mouseY is: ' + mouseX); 
...
function tapToOpen(){
  ...
  if(tapMe == true){
    ...
    stroke(random(myColors));
    fill('white');
    text('TAP TO OPEN', width*.485, height*.815, 20);}}
  pop();
}
...
//background
function circleCorner(xpos, ypos,circleCornerColor){
  push();
  strokeWeight(10);
  circle(width*xpos, height*ypos, 200);
  strokeWeight(2.3);
  fill(random(myColors));
  pop();
}
...
function circusPattern(x1,y1,x2,y2,x3,y3){
  push();
    noStroke();
    fill(random(myColors));
...
function springBalance(x,y,w,h,){
  push();
    fill(random(myColors));
    strokeWeight(5);
    stroke(random(myColors));
...
function eye(xpos, ypos, xpos1, ypos1, xpos2, ypos2){
  push();
    fill(random(myColors));
    strokeWeight(5);
    stroke(random(myColors));
    circle(width*xpos, (height*ypos)- mic.getLevel()*100, 75);
    fill('#ffffff');
    circle(width*xpos1, (height*ypos1) - mic.getLevel()*50, 25);
    fill('#ffffff');
    circle(width*xpos2, (height*ypos2) - mic.getLevel()*50, 10);
  pop();
}
  
function nose(xpos,ypos){
  push();
  fill(random(myColors));
  strokeWeight(5);
  stroke(random(myColors));
...
function mouth(xpos, ypos, xpos1, ypos1){
  push();
    fill(random(myColors));
    strokeWeight(5);
    stroke(random(myColors));
